...
void Render() //Don't forget to call this somewhere! Such as, where you're calling the menu.
{
    ...
    Rendering::DrawText2(Display_get_height(Display_get_main()) * 0.021, ImVec2(Display_get_width(Display_get_main()) * isAutoSlider, Display_get_height(Display_get_main()) * 0.9725), ImVec4(1, 1, 1, 1), OBFUSCATE("Modded by Hitoshi.A - Powered by E.C.F.A. Team."));
